...
export default function NavBar() {
	...
	return (
		<div className="fixed w-full z-20">
			<div className="flex py-4 px-10 bg-transparent items-center ">
				<div className="container absolute px-16">
					<div className="flex items-center  w-full py-2  ">
						<svg
							...
							viewBox="0 0 400 50"
							aria-hidden="true"
							className="h-8 w-auto fill-current text-white mx-16 ">
						...
						<nav className="text-white lg:flex font-bold uppercase gap-x-5 text-nowrap flex-wrap text-sm hidden pr-5 leading-7">
				...
				<div className="uppercase font-bold text-white flex items-center ml-auto text-sm gap-x-5">
